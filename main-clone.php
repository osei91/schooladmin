            ...
            <div class="container-fluid">
                <nav class="pull-left">
                    <ul>
                        ...
                        <li>
                            <a href="#">
                               <strong>Polygon3D Management system</strong>
                            </a>
                        </li>
                ...
                <div class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script>,Brought &nbsp;<i class="ti-heart heart"></i> &nbsp;To You By Polygon3D </a>
                </div>
            </div>
        </footer>
...
<script src="dist/js/pages/dashboard3.js"></script>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'ti-gift',
            	message: "Welcome to <b>  Polygon3D </b> - Management System."
