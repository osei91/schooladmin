...
function students_validateData(){
	...
	if($j('#DOB-dd').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Date Of Birth", close: function(){ $j('#DOB-dd').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#DOB-mm').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Date Of Birth", close: function(){ $j('#DOB-mm').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#DOB').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Date Of Birth", close: function(){ $j('#DOB').focus().parents('.form-group').addClass('has-error'); } }); return false; };
